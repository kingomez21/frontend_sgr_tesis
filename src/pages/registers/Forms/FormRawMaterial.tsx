...
const FormRawMaterial = () => {
    ...
    const { collections, materialTypes, setUpdated } = useRegisterContext()
    ...
    const submit = () => {
        ...
        .then((data) => {
            ...
            setRefresh(kgQuantity+1)
            //setUpdated(kgQuantity)
        })
        .catch(() => {
            setStatusErr(true)
        ...
        <Dialog open fullScreen>
            ...
            <DialogContent>
                ...
                <Box marginLeft={4} marginRight={4}>
                    ...
                    <Stack>
                        <ViewListRawMaterialPerCollection idCollection={idCollection} collections={collections} updated={refresh} />
                    </Stack>
...
const ViewListRawMaterialPerCollection = ({ idCollection, collections, updated }: props) => {
